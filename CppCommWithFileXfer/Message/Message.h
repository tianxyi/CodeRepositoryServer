...
namespace MsgPassingCommunication
{
  ...
  {
    return address + ":" + Utilities1::Converter<size_t>::toString(port);//
  }
  ...
  inline EndPoint EndPoint::fromString(const std::string& str)
  {
    ...
    ep.port = Utilities1::Converter<size_t>::toValue(portStr);//
    return ep;
  }
  ///////////////////////////////////////////////////////////////////
  // Message class
  ...
  public:
    ...
    using Attributes = std::unordered_map<Key, Value>;//name-value pair
   ...
   // std::string Regex();/////////
    ...
    void clear();
    std::string toString();//serilizaed
    static Message fromString(const std::string& src);//deserilized
