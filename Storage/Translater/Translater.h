...
namespace MsgPassingCommunication
{
  ...
  void Translater::listen(CsEndPoint^ ep)//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  {
    ...
    pComm->start();//add the path here both interface stuff/communication stuff add argument is start//start(string rcvpatj="../savefiles",sed::string& sndPath ="../SendFiles")
    delete pFactory;
  }
  ...
  inline CsMessage^ Translater::getMessage()//C++->C# msg send to GUI 
  {
